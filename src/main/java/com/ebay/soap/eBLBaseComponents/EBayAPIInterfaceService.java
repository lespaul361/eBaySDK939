 ...
 * 
 */
@WebServiceClient(name = "eBayAPIInterfaceService", targetNamespace = "urn:ebay:apis:eBLBaseComponents", wsdlLocation = "file:/D:/JavaProjects/ebaysdkcore939-2/src/main/resources/ebaySvc.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "file:/D:/JavaProjects/ebaysdkcore939-2/src/main/resources/ebaySvc.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'file:/D:/JavaProjects/ebaysdkcore939-2/src/main/resources/ebaySvc.wsdl', retrying as a local file");
